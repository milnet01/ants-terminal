...
constexpr const char *kOrientationScriptBody =
    ...
    "  • roadmap_query    → read ROADMAP bullets, sections, single IDs\n"
    "  • workspace_search → cheap grep wrapper (lane-aware, dedup, clip)\n"
    ...
    "most read verbs accept etag_match + fields= for cheap re-reads.\n"
    "\n"
