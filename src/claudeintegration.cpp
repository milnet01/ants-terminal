            ...
            if (method == "initialize") {
                    ...
                    "for full-text edits.");
                {
                    ...
                    inclBodyProp["description"] = QStringLiteral(
                        ...
                        "declares that field. Nothing marks a composed line "
                        "and nothing can: the markdown backend parses the "
                        "rendered file and cannot know which lines a renderer "
                        "wrote, so marking one backend would diverge the two. "
                        "Read the store's `item.body` column when the "
                        "body-vs-column divergence is the question. "
