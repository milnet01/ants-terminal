...
BriefManifest assembleBriefManifest(const QString &projectPath,
    ...
    b += QStringLiteral(
        ...
        "CRUCIAL (ANTS-3586): these logs are append-only HISTORY, not a live "
        "defect list — a ✅/Resolved/shipped bullet describes PAST state "
        "(the fix already landed) and a 📋 bullet is already-tracked "
        "work. Verify every such matched bullet against CURRENT source before "
        "reporting it, and NEVER report a Resolved bullet as an open "
        "problem.\n\n"
