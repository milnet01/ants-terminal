...
<p align="center">
  Current version: <strong>0.7.48</strong> — see the <a href="CHANGELOG.md">CHANGELOG</a> for release notes, the <a href="ROADMAP.md">ROADMAP</a> for what's coming, and <a href="PLUGINS.md">PLUGINS</a> for the plugin authoring guide.
</p>
...
curl -L -o Ants_Terminal-x86_64.AppImage \
  https://github.com/milnet01/ants-terminal/releases/latest/download/Ants_Terminal-0.7.48-x86_64.AppImage
