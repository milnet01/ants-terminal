...
- ✅ [ANTS-4320] **Scrollback regex search**
...
- ✅ [ANTS-4323] **Declarative permissions in `manifest.json`**
  — `permissions`
...
- ✅ [ANTS-4325] **`ants.settings.get / .set`**
...
- ✅ [ANTS-4326] **`ants.clipboard.write(text)`**
  — gated by `"clipboard.write"`.
  Kind: implement.

- ✅ [ANTS-4327] **Hot reload**
