...
*value* changed, so this section's conclusion stands, and so does every
committed golden **as regenerated by this change** (§ 2.4 regenerates the three;
what does not move is the `meta.schema` discriminator) —
