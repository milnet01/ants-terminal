...
> `~/.claude/standards/security.md`; everything below is a verbatim copy of
> it, kept in the repo because this repo is public and a reader who has only
> the checkout cannot follow a pointer into a private home directory.
>
...
>
> Refresh with:
> `cp ~/.claude/standards/security.md docs/standards/security.md` and
> re-apply this header. Project-specific security rules do **not** go here —
> they go in [`coding.md`](coding.md) alongside the other project deltas.
>
