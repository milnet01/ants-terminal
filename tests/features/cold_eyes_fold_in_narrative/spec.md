# cold_eyes_fold_in narrative_mode (ANTS-1644)

Source-grep feature test for the narrative-mode port from ANTS-1635
(test_audit_fold_in) into the cold-eyes sibling.
...
- **INV-1** Handler shorts to narrative mode when
  ...
  `### 📝 Cold-eyes`. Branch is positioned AFTER
